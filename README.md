...
Also, this package was started by Dawson, but I want to add addition features. Forking was not a viable option.
...
'providers' => [
	...
	'Craytor\Youtube\YoutubeServiceProvider',
],
```
...
'aliases' => [
	...
	'Youtube' => 'Craytor\Youtube\YoutubeFacade',
],
```
...
```
php artisan vendor:publish --provider="Craytor\Youtube\YoutubeServiceProvider"
```
